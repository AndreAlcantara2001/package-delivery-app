                            ...
                            <v-form @submit.prevent="submitRequestDelivery">
                                <v-row>
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        <v-text-field v-model="preDelivery.customerId" label="Customer Id" required
                                ...
                                <v-row>
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        <v-text-field v-model="preDelivery.receiverPhone" label="Receiver Phone Number"
                                            required outlined></v-text-field>
                                    </v-col>
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        <v-text-field v-model="detailsAddress" label="Reciever Building No,Street Name"
                                            required outlined>Reciever Building No,Street Name</v-text-field>
                                    </v-col>
                                </v-row>

                                <v-row>
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        <v-text-field v-model="preDelivery.pickupAddressText" label="Pick Up Address"
                                            required outlined readonly></v-text-field>
                                    </v-col>
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        <v-text-field v-model="preDelivery.destinationAddressText" label="Reciever Address"
                                            required outlined readonly></v-text-field>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    ...
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        <v-text-field v-model="preDelivery.cost" label="Cost" required
                                            outlined></v-text-field>
                                    </v-col>
                                </v-row>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" lg="6" md="6" class="inputCol">
                                        ...
                                        <v-radio-group v-model="radios" mandatory style="padding: 0; margin-top: 0;">
                                            ...
                                            <v-radio label="KBZ pay" value="radio-2"></v-radio>
                                        </v-radio-group>
...
export default {
    ...
    methods: {
        ...
        findDistance(lat1, lng1, lat2, lng2) {
            ...
            const R = 6371; // Earth's radius in kilo meters
        ...
        submitRequestDelivery() {
            ...
            //this.$router.push({name: 'GetNearRiders', params: this.preDeliId})
        }
    }
};
</script>
